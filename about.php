...
<body>
    ...
    <div class="intro-container">
        <div class="intro-text">
            <h2>Welcome to Sunny Socks</h2>
            <h2>The Bright Side of Socks</h2>
            <p>At Sunny Socks, we specialize in providing high-quality, durable socks for international industries. Our focus is on delivering the best footwear solutions for sectors like construction, oil & gas, military, and other high-demand fields. We cater exclusively to business clients, ensuring that your workforce stays comfortable and warm, no matter the conditions.</p>
        </div>
    </div>
    ...
    <div class="grid-container">
        <div class="grid-item">
            ...
            <p>With a focus on serving the global market, Sunny Socks ensures every order, no matter the location, arrives on time. Our logistics team handles shipping to major industrial hubs and remote work sites, delivering our socks to clients around the world.</p>
        </div>
        ...
        <img src="img/sunny_socks_stock photo.png" alt="sock">

        <hr>

        <img src="img/mil_socks.png" alt="military socks">
        ...
        <div class="grid-item">
            ...
            <p>At Sunny Socks, we believe in sustainability. Our packaging is simple yet sturdy, designed to protect the products during transit while minimizing environmental impact. Each sock is folded neatly with a recycled cardboard holder, indicating size and brand, ready to ship directly to your business.</p>
        </div>

        <img src="img/sunny_socks_packages.png" alt="packaging">
    </div>
